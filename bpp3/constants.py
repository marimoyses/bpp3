import os
primer3Location = '/PHShome/hw878/Software/primer3/src/primer3_core'; # path for primer3_core command
primer3ParametersLocation = '/PHShome/hw878/Software/primer3/src/primer3_config/'; # path for 'primer3_config' file
...
genomeDir = '/data/talkowski/tools/ref/'; # path for directory containing genome build directories (e.g. 'hg19')
